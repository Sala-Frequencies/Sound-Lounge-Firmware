...
**Current firmware version:** **0.15.152**
...
| `music_player_ui_0.15.152.bin` | Music player touchscreen (ESP32) |
| `music_player_sound_0.15.152.bin` | Music player sound module (Teensy) |
| `sound_lounge_0.15.152.bin` | Sound Lounge zones module (Teensy) |
