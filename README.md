...
**Current firmware version:** **0.15.89**
...
| `music_player_ui_0.15.89.bin` | Music player touchscreen (ESP32) |
| `music_player_sound_0.15.89.bin` | Music player sound module (Teensy) |
| `sound_lounge_0.15.89.bin` | Sound Lounge zones module (Teensy) |
